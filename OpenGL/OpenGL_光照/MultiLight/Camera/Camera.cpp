...
void display() {
	...
	//使用Shader
	Shader lightShader = Shader("multiLightVertex.vs", "multiLightFragment.fs");
	lightShader.use();
	...
	lightShader.setVec3("dirLight.diffuse", 0.05f, 0.05f, 0.05f);
	lightShader.setVec3("dirLight.specular", 0.2f, 0.2f, 0.2f);

	//点光源数组参数
	lightShader.setVec3("pointLights[0].position", pointLightPositions[0]);
	lightShader.setVec3("pointLights[0].ambient", 0.01f, 0.01f, 0.01f);
	lightShader.setVec3("pointLights[0].diffuse", 0.1f, 0.1f, 0.1f);
	lightShader.setVec3("pointLights[0].specular", 0.1f, 0.1f, 0.1f);
	lightShader.setFloat("pointLights[0].constant", 1.0f);
	lightShader.setFloat("pointLights[0].linear", 0.14);
	lightShader.setFloat("pointLights[0].quadratic", 0.07);

	lightShader.setVec3("pointLights[1].position", pointLightPositions[1]);
	lightShader.setVec3("pointLights[1].ambient", 0.01f, 0.01f, 0.01f);
	lightShader.setVec3("pointLights[1].diffuse", 0.1f, 0.1f, 0.1f);
	lightShader.setVec3("pointLights[1].specular", 0.1f, 0.1f, 0.1f);
	lightShader.setFloat("pointLights[1].constant", 1.0f);
	lightShader.setFloat("pointLights[1].linear", 0.14);
	lightShader.setFloat("pointLights[1].quadratic", 0.07);

	lightShader.setVec3("pointLights[2].position", pointLightPositions[2]);
	lightShader.setVec3("pointLights[2].ambient", 0.01f, 0.01f, 0.01f);
	lightShader.setVec3("pointLights[2].diffuse", 0.1f, 0.1f, 0.1f);
	lightShader.setVec3("pointLights[2].specular", 0.1f, 0.1f, 0.1f);
	lightShader.setFloat("pointLights[2].constant", 1.0f);
	lightShader.setFloat("pointLights[2].linear", 0.22);
	lightShader.setFloat("pointLights[2].quadratic", 0.20);

	lightShader.setVec3("pointLights[3].position", pointLightPositions[3]);
	lightShader.setVec3("pointLights[3].ambient", 0.03f, 0.01f, 0.01f);
	lightShader.setVec3("pointLights[3].diffuse", 0.3f, 0.1f, 0.1f);
	lightShader.setVec3("pointLights[3].specular", 0.3f, 0.1f, 0.1f);
	lightShader.setFloat("pointLights[3].constant", 1.0f);
	lightShader.setFloat("pointLights[3].linear", 0.14);
	lightShader.setFloat("pointLights[3].quadratic", 0.07);
	...
	lightShader.setFloat("spotLight.cutOff", glm::cos(glm::radians(10.5f)));
